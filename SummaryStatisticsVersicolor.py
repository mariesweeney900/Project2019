...
Species1 = dataframe.loc[dataframe['species'] == 'versicolor']
Species1.describe()
...
#makes a dataframe from the species versicolor therby isolating it from other species and labelling it species2